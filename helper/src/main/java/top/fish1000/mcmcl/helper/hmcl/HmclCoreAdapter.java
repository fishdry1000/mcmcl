 ...
 *
 * <p>
 * The default build supplies an unavailable implementation; the opt-in
 ...
 * ProcessListener are deliberately kept on that profile side of this seam.
 * </p>
 */
public interface HmclCoreAdapter {
     ...
     *
     * <p>
     * With a null component this returns the game versions offered by the
     ...
     * loader for the given game version.
     * </p>
     */
     ...
     *
     * <p>
     * A request with a game version creates a new vanilla instance;
     ...
     * {@link HmclLaunchEventSink#error(String)}.
     * </p>
     */
     ...
     *
     * <p>
     * The adapter owns the actual launch task. Repository preparation and
